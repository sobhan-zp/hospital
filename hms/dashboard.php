        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">پنل کاربری بیمار</h1>
                        </div>
                        <ol class="breadcrumb">
                            <li>
                                <span>بیمار</span>
                        ...
                        <div class="col-sm-4">
                            <div class="panel panel-white no-radius text-center">
                                <div class="panel-body">
                                    ...
                                    <h2 class="StepTitle">پروفایل من</h2>
                        ...
                        <div class="col-sm-4">
                            <div class="panel panel-white no-radius text-center">
                                <div class="panel-body">
                                    ...
                                    <h2 class="StepTitle"> قرار ملاقات </h2>

                                    <p class="cl-effect-1">
                                        <a href="appointment-history.php">
                                            مشاهده ملاقات های اخیر
                                        </a>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="panel panel-white no-radius text-center">
                                <div class="panel-body">
                                    ...
                                    <h2 class="StepTitle">نوبت گیری</h2>
