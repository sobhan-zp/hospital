				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">ادمین | مدیریت دکتر</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>ادمین</span>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">مدیریت <span class="text-bold">دکتر</span></h5>
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												<th class="center">#</th>
												<th>تخصص</th>
												<th class="hidden-xs">نام دکتر</th>
												<th>زمان ثبت نام</th>
												<th>وضعیت</th>
