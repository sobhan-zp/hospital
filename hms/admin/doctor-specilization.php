...
$_SESSION['msg']="تخصص با موفقیت اضافه شد !!";
}
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">مدیر | اضافه کردن تخصص دکتر</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>مدیر</span>
									...
									<li class="active">
										<span>اضافه کردن تخصص دکتر</span>
									</li>
								</ol>
							</div>
						</section>
						...
						<div class="container-fluid container-fullw bg-white">
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title"> تخصص دکتر</h5>
												</div>
							...
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="تخصص دکتر را وارد کنید">
														</div>
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">مدیریت <span class="text-bold">تخصص دکتر ها</span></h5>
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												<th class="center">#</th>
												<th>تخصص</th>
												<th class="hidden-xs">زمان اضافه شدن</th>
