...
<html lang="en">
	<head>
		<title>ادمین | مدیریت بیمار</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">ادمین | مدیریت بیمار</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>ادمین</span>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">مدیریت <span class="text-bold">بیمار</span></h5>
