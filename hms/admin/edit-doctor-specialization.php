...
$_SESSION['msg']="با موفقیت بروزرسانی شد  !!";
}
...
<html lang="en">
	<head>
		<title>مدیر | ویرایش تخصص دکتر</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">مدیر | ویرایش تخصص دکتر</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>مدیر</span>
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">ویرایش تخصص دکتر</h5>
												</div>
