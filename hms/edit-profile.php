...
<html lang="en">
<head>
    <title>بیمار | ویرایش اطلاعات</title>
    <meta charset="utf-8"/>
    <meta name="viewport"
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">بیمار | ویرایش اطلاعات</h1>
                        </div>
                        <ol class="breadcrumb">
                            <li>
                                <span>بیمار </span>
                                ...
                                <div class="col-lg-8 col-md-12">
                                    <div class="panel panel-white">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">ویرایش اطلاعات</h5>
                                        </div>
                                            ...
                                            while ($data = mysqli_fetch_array($sql)) {
                                                ...
                                                <form role="form" name="edit" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <a href="change-emaild.php">ویرایش ایمیل</a>
                                                    </div>
