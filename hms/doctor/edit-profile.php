...
if (isset($_POST['submit'])) {
    ...
    if ($sql) {
        echo "<script>alert('پروفایل شما بروزرسانی شد');</script>";
...
<html lang="en">
<head>
    <title>دکتر | ویرایش اطلاعات</title>
    <meta charset="utf-8"/>
    <meta name="viewport"
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">دکتر | ویرایش اطلاعات</h1>
                        </div>
                        <ol class="breadcrumb">
                            <li>
                                <span>دکتر</span>
                                ...
                                <div class="col-lg-8 col-md-12">
                                    <div class="panel panel-white">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">ویرایش دکتر</h5>
                                        </div>
